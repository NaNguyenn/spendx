...
export const Colors = {
  light: {
    ...
    catFoodSoft: '#FDEBDD',
    catHousing: '#2F5FD0',
    catHousingSoft: '#E2EAFC',
    catTransportation: '#5F8C0C',
    catTransportationSoft: '#EDF4DC',
    catVehicle: '#8A5A2B',
    catVehicleSoft: '#F5EBE0',
    catShopping: '#D6318E',
    catShoppingSoft: '#FCE4F1',
    catLeisure: '#7A2FC9',
    catLeisureSoft: '#ECE3FB',
    catHealth: '#D33A41',
    catHealthSoft: '#FCE4E5',
    catEducation: '#A87B05',
    catEducationSoft: '#F9F0D4',
    catTravel: '#0E90D1',
    catTravelSoft: '#DDEFFA',
  ...
  dark: {
    ...
    catFoodSoft: '#412104',
    catHousing: '#7BA4FF',
    catHousingSoft: '#14224A',
    catTransportation: '#A3CE45',
    catTransportationSoft: '#22300A',
    catVehicle: '#C99560',
    catVehicleSoft: '#33210F',
    catShopping: '#FF74BC',
    catShoppingSoft: '#43112F',
    catLeisure: '#B98CFF',
    catLeisureSoft: '#241046',
    catHealth: '#FF7B80',
    catHealthSoft: '#3F1114',
    catEducation: '#EDBB33',
    catEducationSoft: '#362803',
    catTravel: '#4EC0F5',
    catTravelSoft: '#06304A',
